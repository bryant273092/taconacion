        ...
        <FooterContainer>
            <FooterItems>
                <FooterItem>
                    ...
                    <IconContainer>
                        <FooterIcon>
                            <FontAwesomeIcon href="https://www.instagram.com/taco_nacion/" icon={faInstagram}></FontAwesomeIcon>
                        </FooterIcon>
                        <FooterIcon>
                            <FontAwesomeIcon href="https://www.yelp.com/biz/taco-nacion-ontario" icon={faYelp}></FontAwesomeIcon>
                        </FooterIcon>
                        <FooterIcon>
